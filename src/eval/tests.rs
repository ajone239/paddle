...
mod macros {
    ...
    fn defm_args_not_evaluated_before_expansion() {
        // The macro receives the raw unevaluated arg; if args were pre-evaluated
        // this would error because `undefined-var` doesn't exist in the env.
        assert_eq!(
            eval_str_env(&vec![
    ...
    fn define_macro_keyword() {
        // define-macro is the long form of defm
        assert_eq!(
            eval_str_env(&vec![
